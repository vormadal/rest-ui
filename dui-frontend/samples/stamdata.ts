        ...
        parameters: [
          {
            name: 'agreementid',
            in: 'query',
            description: '8-digit id for the SKI agreement or tender (e.g. 50480022)',
            style: 'form',
            schema: {
              type: 'string'
            }
      ...
      put: {
        ...
        parameters: [
          ...
          },
          {
            name: 'action',
            in: 'query',
            description: 'What shall happen to the supplierreport(s) on the agreement',
            required: true,
            style: 'form',
            schema: {
              type: 'string'
        ...
        parameters: [
          {
            name: 'q',
            in: 'query',
            description: 'What period the organizations agreements should report on',
            required: true,
            style: 'form',
            schema: {
              type: 'string'
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            name: 'endDateAfter',
            in: 'query',
            description: 'Henter aftaler med indrapporteringsaftaler med slutdato efter denne dato',
            style: 'form',
            schema: {
              type: 'string',
              format: 'date-time'
        ...
        parameters: [
          {
            name: 'status',
            in: 'query',
            description: 'Kind of agreements. Possible values: tender, agreement, expired',
            style: 'form',
            schema: {
              type: 'string'
            }
        ...
        parameters: [
          {
            name: 'id',
            in: 'path',
            description: 'This is the email of the person and is used as unique identifier',
            required: true,
            style: 'simple',
            schema: {
              type: 'string'
        ...
        parameters: [
          {
            name: 'orgIds',
            in: 'query',
            description: 'Filter result by organization ids. (orgIds and orgType are mutually exclusive parameters)',
            style: 'form',
            explode: false,
            schema: {
              type: 'array',
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            ...
            in: 'query',
            description: 'Bool value that indicates if subagreements should be excluded in the response',
            style: 'form',
            schema: {
              type: 'string'
            }
